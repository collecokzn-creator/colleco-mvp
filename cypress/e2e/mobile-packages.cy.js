// Mobile viewport checks for Packages page responsive behavior
const viewports = [
...
describe('Mobile Packages responsiveness', () => {
  ...
  cy.contains(/Our Packages/i, { timeout: 30000 }).should('exist')
      cy.window().then((win) => {
