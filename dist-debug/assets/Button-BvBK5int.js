...
function Button({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, { type: Component === "button" ? type : void 0, disabled, className: composed, ...rest, children });
}
export {
  Button as B
};
//# sourceMappingURL=Button-BvBK5int.js.map
