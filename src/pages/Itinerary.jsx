...
export default function Itinerary() {
  ...
  return (
    <>
    <div className={"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-brand-brown " + (highContrastFocus ? 'focus-visible:outline-none [&_*:focus-visible]:outline [&_*:focus-visible]:outline-2 [&_*:focus-visible]:outline-offset-2 [&_*:focus-visible]:outline-brand-brown' : '')}>
