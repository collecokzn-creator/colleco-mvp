          ...
          <div className="border-t pt-6">
            ...
            <div className="bg-blue-50 border-2 border-blue-400 rounded-lg p-4 mb-4">
              ...
              <p className="text-sm text-blue-900 mb-3">
                Need to escalate or speak directly with a specialist? Connect with transfer product owners and service providers for complex issues, special requests, or personalized assistance.
              </p>
              <button 
                onClick={() => {
